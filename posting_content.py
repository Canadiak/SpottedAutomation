...
params['media_url'] = 'https://www.smashbros.com/assets_v2/img/fighter/mega_man/main.png' # url on public server for the post
params['caption'] = 'Posted with Python'
...
print( "\n---- IMAGE MEDIA OBJECT -----\n" ) # title
print( "\tID:" ) # label # 17891151077427609
...
params['caption'] = 'This was also posted with Python'
